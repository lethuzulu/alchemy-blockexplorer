...
function App() {
                            ...
                            {blockTransactions.map((transaction) => {
                                return (
                                    <tr
                                        ...
                                        <th>
                                            {getSubstring(transaction.hash, 15)}
                                        </th>
                                        <th>{transaction.blockNumber}</th>
                                        <th>
                                            {getSubstring(transaction.from, 15)}
                                        </th>
                                        <th>
                                            {getSubstring(transaction.to, 15)}
                                        </th>
                                        ...
                                        <th>
                                            {getSubstring(transaction.data, 15)}
                                        </th>
                                    </tr>
                                )
                            })}
        ...
        return (
            <>
                ...
                <Detail
                    ...
                    value={props.transaction.hash}
                />
                <Detail
                    name={'Block'}
                    value={props.transaction.blockNumber}
                />
                <Detail
                    name={'From'}
                    value={props.transaction.from}
                />
                <Detail
                    name={'To'}
                    value={props.transaction.to}
                />
                <Detail
                    name={'Confirmations'}
    ...
    return (
        <>
            ...
            <Transactions />
            <TransactionDetail
                transaction={getTransaction(transactionSelected)}
            />
        </>
    )
}
